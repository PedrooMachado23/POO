...
export function ClientPage() {
    ...
    const [users, setUsers] = useState<User[]>([
        {
            ...
            nomeSocial: 'Pedrin',
            cpf: { valor: '00000000000', dataEmissao: new Date('01/10/2001') },
            genero: 'masculino',
        },
        {
            id: 2,
            nome: 'Pedro',
            nomeSocial: 'Pe',
            cpf: { valor: '11122288870', dataEmissao: new Date('01/01/2001') },
            genero: 'masculino',
        },
        {
            id: 3,
            nome: 'Esther',
            nomeSocial: 'Tete',
            cpf: { valor: '11122233344', dataEmissao: new Date('01/01/2001') },
            genero: 'feminino',
        },
        {
            id: 4,
            nome: 'Lucas',
            nomeSocial: 'Luca',
            cpf: { valor: '11122255566', dataEmissao: new Date('02/02/2001') },
            genero: 'masculino',
        },
        {
            id: 5,
            nome: 'Ana',
            nomeSocial: 'Aninha',
            cpf: { valor: '11122277788', dataEmissao: new Date('03/03/2001') },
            genero: 'feminino',
        },
        {
            id: 6,
            nome: 'João',
            nomeSocial: 'Jota',
            cpf: { valor: '11122299900', dataEmissao: new Date('04/04/2001') },
            genero: 'masculino',
        },
        {
            id: 7,
            nome: 'Maria',
            nomeSocial: 'Mari',
            cpf: { valor: '11122311122', dataEmissao: new Date('05/05/2001') },
            genero: 'feminino',
        },
        {
            id: 8,
            nome: 'Carlos',
            nomeSocial: 'Carlão',
            cpf: { valor: '11122333344', dataEmissao: new Date('06/06/2001') },
            genero: 'masculino',
        },
        {
            id: 9,
            nome: 'Fernanda',
            nomeSocial: 'Fê',
            cpf: { valor: '11122355566', dataEmissao: new Date('07/07/2001') },
            genero: 'feminino',
        },
        {
            id: 10,
            nome: 'Gabriel',
            nomeSocial: 'Gabi',
            cpf: { valor: '11122377788', dataEmissao: new Date('08/08/2001') },
            genero: 'masculino',
        },
        {
            id: 11,
            nome: 'Rafaela',
            nomeSocial: 'Rafa',
            cpf: { valor: '11122399900', dataEmissao: new Date('09/09/2001') },
            genero: 'feminino',
        },
        {
            id: 12,
            nome: 'Felipe',
            nomeSocial: 'Fê',
            cpf: { valor: '11122411122', dataEmissao: new Date('10/10/2001') },
            genero: 'masculino',
        },
        {
            id: 13,
            nome: 'Juliana',
            nomeSocial: 'Ju',
            cpf: { valor: '11122433344', dataEmissao: new Date('11/11/2001') },
            genero: 'feminino',
        },
        {
            id: 14,
            nome: 'Roberto',
            nomeSocial: 'Bob',
            cpf: { valor: '11122455566', dataEmissao: new Date('12/12/2001') },
            genero: 'masculino',
        },
        {
            id: 15,
            nome: 'Sofia',
            nomeSocial: 'Sô',
            cpf: { valor: '11122477788', dataEmissao: new Date('13/01/2001') },
            genero: 'feminino',
        },
        {
            id: 16,
            nome: 'Vinícius',
            nomeSocial: 'Vini',
            cpf: { valor: '11122499900', dataEmissao: new Date('14/02/2001') },
            genero: 'masculino',
        },
        {
            id: 17,
            nome: 'Tatiane',
            nomeSocial: 'Tati',
            cpf: { valor: '11122511122', dataEmissao: new Date('15/03/2001') },
            genero: 'feminino',
        },
        {
            id: 18,
            nome: 'André',
            nomeSocial: 'Dre',
            cpf: { valor: '11122533344', dataEmissao: new Date('16/04/2001') },
            genero: 'masculino',
        },
        {
            id: 19,
            nome: 'Camila',
            nomeSocial: 'Cami',
            cpf: { valor: '11122555566', dataEmissao: new Date('17/05/2001') },
            genero: 'feminino',
        },
        {
            id: 20,
            nome: 'Bruno',
            nomeSocial: 'Bru',
            cpf: { valor: '11122577788', dataEmissao: new Date('18/06/2001') },
            genero: 'masculino',
        },
        {
            id: 21,
            nome: 'Isabela',
            nomeSocial: 'Bel',
            cpf: { valor: '11122599900', dataEmissao: new Date('19/07/2001') },
            genero: 'feminino',
        },
    ]);
    ...
    const handleDeleteUser = (userId: number) => {
        setUsers((prevArray) => prevArray.filter(user => user.id !== userId))
    }
                        ...
                        <div className="d-flex flex-column mx-auto flex-grow-1">
                            <form action="" className="d-flex flex-column mt-5 col editingForm">
                                    ...
                                    <input type="text" className="mb-3 border border-2 rounded p-1 px-2"
                                        ...
                                        onChange={(e) => setEditingUser({...editingUser, nomeSocial: e.target.value})}/>
                                    ...
                                    <div className="d-none d-sm-flex flex-column">
                                        ...
                                        <div>
                                            <input type="text" className="me-2 border border-2 rounded p-1 px-2"
                                                ...
                                                onChange={(e) => setEditingUser({...editingUser, cpf: {...editingUser.cpf, valor: e.target.value}})} />
                                            <input type="text" className="ms-2 mb-3 border border-2 rounded p-1 px-2"
                                                ...
                                                onChange={(e) => setEditingUser({...editingUser, cpf: {...editingUser.cpf, dataEmissao: new Date(e.target.value)}})}/>
                                        </div>
                                    </div>
                            ...
                            <div className="d-flex justify-content-between align-items mt-4 mb-5">
                                <button className="btn btn-success table-button-pattern" onClick={() => handleEditUser(0)}>Salvar</button>
